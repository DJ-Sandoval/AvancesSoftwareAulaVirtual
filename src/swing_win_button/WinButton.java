...
public class WinButton extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdClose = new swing_win_button.Button();
        cmdMi = new swing_win_button.Button();
        cmdRe = new swing_win_button.Button();
    ...
    private swing_win_button.Button cmdClose;
    private swing_win_button.Button cmdMi;
    private swing_win_button.Button cmdRe;
